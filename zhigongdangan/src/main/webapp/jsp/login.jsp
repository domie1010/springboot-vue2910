	...
	<div class="page-form">
        <form id="loginForm" action="" method="post" class="form">
            ...
            <div class="body-content">
				...
				<div class="form-group"><button type="button" class="btn btn-success"  style="width: 100%;background-color:var(--publicSubColor, #F37335);color: #FFFFFF;"  onclick="window.location.href='./modules/yonghu/register.jsp'">注册  职工</button></div>
