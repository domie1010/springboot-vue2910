                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 yonghuPhoneDiv">
                                        ...
                                        <input style="width: 450px" id="yonghuPhone" name="yonghuPhone" class="form-control"
                                               onchange="yonghuPhoneChickValue(this)"  placeholder="职工手机号">
                                    </div>
                                    <div class="form-group col-md-6 yonghuIdNumberDiv">
                                        ...
                                        <input style="width: 450px" id="yonghuIdNumber" name="yonghuIdNumber" class="form-control"
                                               onchange="yonghuIdNumberChickValue(this)"  placeholder="职工身份证号">
                                    </div>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                ...
                yonghuName: "职工姓名不能为空",
                yonghuPhoto: "头像不能为空",
                yonghuPhone: "职工手机号不能为空",
                yonghuIdNumber: "职工身份证号不能为空",
                yonghuEmail: "邮箱不能为空",
                sexTypes: "性别不能为空",
            }
        }).form();
